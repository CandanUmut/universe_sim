import 'dart:async';
import 'dart:ui';
import 'package:flame/input.dart' show TapDetector;
...
class GameRoot extends FlameGame with PanDetector, ScaleDetector, TapDetector {
  ...
  void onTapUp(TapUpInfo info) {
    ...
    // change 2: no .toVector2(); global is already a Flame Vector2
    final p = info.eventPosition.global;
    final vm.Vector2 world = cameraController.screenToWorld(
      vm.Vector2(p.x, p.y),
      screenSize,
    );
